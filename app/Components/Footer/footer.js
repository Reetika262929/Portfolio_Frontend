...
const Footer = () => {
  return (
    <>
      <a href="mailto:reetika.062006@gmail.com" _target="blank" style={{ textDecoration: 'none' }}>
        <div className='email-box d-flex align-items-center gap-4 justify-content-center' style={{ cursor: 'pointer' }}>
          <div>
            <p>Shoot me a Mail</p>
          </div>
          <div>
